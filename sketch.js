//cambie la tecla de flecha hacia arriba por la de espacio ya que no me al intentar ponerla me marcaba error, no se si escribia mal la tecla o algo pero me parecio que tambien estaba bien usar la tecla de espacio
...
//establece el colisionador para el mainCyclist
  mainCyclist.setCollider ("rectangle",0,0,mainCyclist.width/2, mainCyclist.height);
...
function draw() {
  ...
  text("¡Presiona la tecla de espacio para reiniciar el juego!",100,40 );
